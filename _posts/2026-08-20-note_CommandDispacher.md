---
layout: single
title: "CommandDispacher"
excerpt: "CommandDispacher"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-08-20"
last_modified_at: "2026-08-20 17:27:13 +0900"
mermaid: true
---
### 1. 결론
...
### 4. `CommandDispatcher`를 중복 로그인에 적용하는 원리
...
### 6. 현재 `server` cache-container를 이용할 수 있는 이유
...
### 10. `CommandDispatcher`만으로 구현하는 것은 왜 부족한가
...
### 12. 운영 EAP 7.2에서 직접 사용 가능 여부를 100% 확인하는 방법
...
#### 12-3. ③ 실제 설치 버전의 메서드 signature 확인
