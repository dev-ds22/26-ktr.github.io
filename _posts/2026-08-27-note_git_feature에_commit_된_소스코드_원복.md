---
layout: single
title: "git_feature에_commit_된_소스코드_원복"
excerpt: "git_feature에_commit_된_소스코드_원복"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-08-27"
last_modified_at: "2026-08-27 14:54:32 +0900"
mermaid: false
---
### 1. `feature/test1`의 커밋된 소스를 `origin/dev` 버전으로 원복하는 방법
...
### 2. 권장: 기존 `feature/test1` 커밋 이력은 유지하고 소스만 `origin/dev` 상태로 되돌리기
...
### 5. `feature/test1` 자체를 완전히 `origin/dev`와 동일하게 만들고 기존 feature 커밋도 버리는 경우
