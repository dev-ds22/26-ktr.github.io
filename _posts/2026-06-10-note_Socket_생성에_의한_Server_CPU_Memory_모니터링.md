---
layout: single
title: "Socket_생성에_의한_Server_CPU_Memory_모니터링"
excerpt: "Socket_생성에_의한_Server_CPU_Memory_모니터링"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-06-10"
last_modified_at: "2026-06-10 11:42:45 +0900"
mermaid: true
---
### 1. 핵심 모니터링 관점
...
### 12-3. 💡 JBOSS 소켓 누수(Leak) 분석을 위한 추가 팁
...
### 12-6. 사용된 핵심 커맨드 및 옵션 상세 설명

모니터링의 핵심이 되는 두 명령어 `ps`와 `ss`의 구체적인 작동 원리와 옵션의 의미입니다.

#### 12-6-1. ① `ps` (Process Status) 명령어 옵션
...
#### 12-6-2. ② `ss` (Socket Statistics) 명령어 옵션
