---
layout: single
title: "WAS에서_DB_Connection_모니터링"
excerpt: "WAS에서_DB_Connection_모니터링"
categories:
  - "tech"
tags:
  - "tech"
...
## 4. 5초 간격으로 날짜가 붙은 파일에 저장하는 스크립트
...
## 21. DB Connection Pool 관점과 TCP 상태 차이
...
## 31. `getNumActive + getNumIdle ≈ ss ESTAB` 공식은 조건부로만 사용
