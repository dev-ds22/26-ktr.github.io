...
toc_sticky: true
date: "2026-06-12"
last_modified_at: "2026-06-12 14:37:51 +0900"
mermaid: true
---
### 1. 현재 운영 방식 평가
...
### 4. 권장안 A: dev 전체를 하나의 Release로 운영
...
### 6. Jenkins Pipeline 개선안

#### 6-1. Jenkins Job을 검증과 배포로 분리
...
#### 21-2. 여러 개발자가 같은 Feature Branch를 공유하는 경우
...
### 22. 5단계: `feature → dev` Merge Request
...
#### 25-1. Merge Commit과 Squash Commit 구분
...
### 27. 10단계: 운영 대상 Commit Cherry-pick
...
#### 32-2. 방법 B: Release 조합에서만 발생하는 오류
...
### 33. 12단계: `release → prd` Merge Request
...
### 39. 17단계: 배포 완료 후 Release Branch 정리
...
### 43. `origin/dev is ambiguous` 발생 시
