---
layout: single
title: "Socket_오류_등에_대한_보고서"
excerpt: "Socket_오류_등에_대한_보고서"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-06-09"
last_modified_at: "2026-06-09 17:47:35 +0900"
mermaid: true
---
### 1. bk-fo 운영 장애 원인 분석 및 개선 방향
#### 1-1. DB Transaction · DBCP · Socket Connection 문제를 쉽게 설명하기
...
### 6. 문제 1: DB Connection 비정상 상태 오류
...
### 11. ChainedTransactionManager + REQUIRED의 영향
...
## 25-3. 이슈 2: DB 커넥션 취득 불가 (Transaction 문제)
...
## 25-4. 이슈 3: 외부 API 소켓 오류 (Socket 문제)
