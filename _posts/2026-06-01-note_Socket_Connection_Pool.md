---
layout: single
title: "Socket_Connection_Pool"
excerpt: "Socket_Connection_Pool"
categories:
  - "tech"
tags:
  - "tech"
...
toc_sticky: true
date: "2026-06-01"
last_modified_at: "2026-06-01 17:29:55 +0900"
mermaid: true
---
...
#### 2-1. ① 네트워크 지연의 주범: TCP / TLS Handshake 무한 반복
...
#### 2-2. ② 시스템 자원 고갈: 스레드(Thread)와 소켓(Socket) 누수
...
### 10. 중요한 구분: idle connection만 제거됨
...
### 11. `maxIdleConnections = 0`도 가능한가?
...
### 17-4. `new OkHttpClient().newBuilder().build()`의 문제
...
### 17-6. Spring 5.3 기준 권장 Bean 구성

#### 17-6-1. OkHttpClient Bean 등록
...
### 17-7. 반드시 같이 지켜야 할 점: `Response` close
...
### 17-8. Connection Pool과 Dispatcher는 역할이 다름
