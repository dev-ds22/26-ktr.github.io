...
### 9. 유형 B: Google의 커머스 검색·추천 엔진 사용
...
### 10. 유형 C: Google Search Console 데이터를 추천에 활용
...
### 11. 유형 D: Programmable Search JSON API
