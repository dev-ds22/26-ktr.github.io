...
### ① 가상 스레드(Virtual Threads)의 전면 도입
...
### ③ 비동기 컨텍스트 전파(Context Propagation)의 정교화
...
### 4. Spring 5.3에서 ThreadLocal을 쓰는 대표 지점
...
### 5. Spring MVC 요청에서 ThreadLocal 흐름
...
### 6. Spring Transaction과 ThreadLocal
...
### 7. TransactionSynchronizationManager의 실제 의미
...
### 8. @Async, Executor, Scheduler에서 문제가 생기는 이유
...
### 9. Thread Pool에서 remove가 중요한 이유
...
### 10. Spring이 대신 정리해주는 경우와 직접 정리해야 하는 경우
...
### 12. Spring 5.3 기준 실무 사용 예시

#### 12-1. TenantContext 예시
...
#### 14-1. Imperative MVC/Transaction의 기본 구조는 크게 바뀌지 않음
...
#### 14-2. Reactive에서는 ThreadLocal 대신 Reactor Context가 중요
...
#### 14-3. Spring Framework 6.1에서 ContextPropagatingTaskDecorator 추가
...
#### 14-4. Spring Framework 6.1에서 Virtual Thread 지원 강화
...
#### 14-5. Spring Boot 사용 시 Virtual Thread 설정도 가능
...
### 15. Virtual Thread와 ThreadLocal의 관계
