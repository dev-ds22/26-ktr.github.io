...
### 4. `dataLayer`에 들어온 이벤트를 순서대로 처리
...
### 6. GTM의 Custom HTML 태그가 브라우저에 삽입되어 실행
...
### 인라인 스크립트와 외부 스크립트 차이
#### GTM 태그 안에 JavaScript를 직접 작성
```html
<script>
