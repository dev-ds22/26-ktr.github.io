...
##### 4-1. 검색 API 서버 또는 중간 장비가 연결을 먼저 닫음
...
##### 4-4. HTTP/1.1 Keep-Alive 연결 재사용 중 stale connection 가능성
...
##### 5-1. Spring Bean 형태로 `OkHttpClient` 공용화
...
##### 4-9. WAS 프로세스가 가진 TCP Socket 확인
...
##### 4-12. Java Thread Dump에서 OkHttp 대기 확인
...
### ③ OkHttpClient 커넥션 풀 메트릭 수집 (Spring Boot Actuator)
