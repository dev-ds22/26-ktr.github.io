...
###   2. Round-Robin에서 Local SessionRegistry만 사용하면 발생하는 문제
...
##  4. IP Hash에서도 Local Registry만 사용하면 안 되는 이유

###  Case 1. 다른 네트워크에서 재로그인
...
##  11. `<distributable/>`이 있다면 Round-Robin에서도 HttpSession은 유지 가능
...
##  12. Round-Robin에서는 오히려 Session Cluster와 Token Registry 역할 분리가 중요
...
###   잘못된 설계 ① IP Hash이므로 Local Map 사용
...
##  15. Round-Robin일수록 Local Cache 설계를 조금 주의해야 함
