...
## spring framework 5.3 과 spring-data-commons 1.13.7
...
### 1. Spring Framework 5.3 + spring-data-commons 1.13.7 타당성 검토
...
### 2. ⚠️ 중요: Spring 5.3에서의 Deprecated 경고
...
#### ① 자원 보유 및 대기(Hold and Wait)로 인한 데드락
