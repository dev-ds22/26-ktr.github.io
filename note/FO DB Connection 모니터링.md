## SS 를 통한 모니터링
### [결론] OS 레벨의 실시간 TCP 커넥션 모니터링 완전 가능
...
### 4. 아키텍처적 한계점 및 보완 사항 (확인 불가능한 내용)
...
### [결론] 임시 쉘 스크립트 로깅의 한계와 APM/메트릭 기반 통합 모니터링으로의 전환
...
#### ② 프로덕션 권장형 백그라운드 쉘 스크립트 (DBCP 고갈 및 경고 발생 시 자동 기록)
...
### [추가 정리] 기술 심화: 나이퀴스트-섀넌(Nyquist-Shannon) 정리 기반 폴링 공백 리스크
