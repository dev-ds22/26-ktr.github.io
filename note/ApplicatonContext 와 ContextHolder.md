...
### ② Spring의 특수 스코프 빈(Request, Session Scope) 구현의 기반
...
### 1) RequestContextHolder (Spring Web)
...
```
### 2) SecurityContextHolder (Spring Security)
...
## 참고 - ApplicationContext 와 ServletContext 
...
## 2. ApplicationContext (Spring의 영역)
...
## 3. 전통적인 Spring MVC에서의 계층 구조 (관계성)
...
### 1) Root ApplicationContext (부모 컨테이너)
...
### 2) Servlet ApplicationContext (자식 컨테이너)
...
## 6. Root ApplicationContext와 Servlet ApplicationContext
...
### 6-1. Root WebApplicationContext
...
### 6-2. DispatcherServlet WebApplicationContext
...
## 9. ServletContext와 ApplicationContext의 관계
...
## 11. ApplicationContextHolder 패턴의 관계
...
### 제한적 허용: Spring 밖 객체에서만 Holder 사용
...
## 15. Spring 5.3 XML 프로젝트 기준 점검 포인트
...
### 문제 1. Service에 `@Transactional`이 적용되지 않음
...
### 문제 2. Controller가 Service를 못 찾음
...
### 문제 3. 같은 Bean이 Root와 Child에 중복 등록됨
